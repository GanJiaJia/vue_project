  ...
  <div v-show="isShowSelect_wei">
    ...
    <div class="digit" v-show="isShowSelect_wei">
        ...
        <ul class="wei_ul">
          ...
          <li class="one-li" @click="wan_btn(1)">冠军</li>
          <!-- <router-link >万位</router-link> -->
          <li class="two-li" @click="qian_btn(2)">亚军</li>
          <li class="three-li" @click="bai_btn(3)">季军</li>
          <li class="four-li" @click="shi_btn(4)">第四名</li>
          <li class="five-li" @click="ge_btn(5)">第五名</li>
          <li class="six-li" @click="di6_btn(6)">第六名</li>
          <li class="seven-li" @click="di7_btn(7)">第七名</li>
          <li class="eight-li" @click="di8_btn(8)">第八名</li>
          <li class="nine-li" @click="di9_btn(9)">第九名</li>
          <li class="ten-li" @click="di10_btn(10)">第十名</li>
        </ul>>
    </div>
          ...
          <div class="start-title">
            <table>
              <tr class="start-contents1-title" v-for="(items,indexs) in start_list_box" v-if="indexs==0" style="display:flex">
                <td class="title-width" v-for="(item,index) in items.titles" v-if="index == 0" style="flex:1">{{item}}</td>
                <td class="title-width" v-for="(item,index) in items.titles" v-if="index == 1" style="flex:3">{{item}}</td>
          ...
          <div class="start-body">
            <table>
              <tr v-for="(items,indexs) in start_list_box" v-if="(indexs!= 30 && indexs != 60 && indexs != 100 && indexs != 200)" style="display:flex;">
                <td class="title-width" style="flex:1">{{items.issue_number | slic}}</td>
