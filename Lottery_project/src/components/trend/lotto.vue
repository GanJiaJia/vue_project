  ...
  <div v-show="isShowSelect_wei">
    ...
    <div class="digit" v-show="isShowSelect_wei">
      ...
      <ul class="wei_ul">
        ...
        <li class="one-li" @click="wan_btn(1)">红一</li>
        <!-- <router-link >万位</router-link> -->
        <li class="two-li" @click="qian_btn(2)">红二</li>
        <li class="three-li" @click="bai_btn(3)">红三</li>
        <li class="four-li" @click="shi_btn(4)">红四</li>
        <li class="five-li" @click="ge_btn(5)">红五</li>
        <li class="six-li" @click="lan1_btn(6)">蓝一</li>
        <li class="seven-li" @click="lan2_btn(7)">蓝二</li>
      </ul>>
          ...
          <div class="start-title">
            <table>
              <tr class="start-contents1-title" v-for="(items,indexs) in start_list_box" v-if="indexs==0" style="display:flex;">
                ...
                <td class="title-width" style="flex:3" v-for="(item,index) in items.titles" v-if="index == 1">{{item}}</td>
                <td v-for="(item,index) in items.titles" v-if="index == 2" style="flex:1">
                  {{item}}
                </td>
                <td v-for="(item,index) in items.titles" v-if="index == 3" style="flex:1">
                  {{item}}
                </td>
              </tr>
            </table>
          ...
          <div class="start-body">
            <table>
              <tr v-for="(items,indexs) in start_list_box" v-if="(indexs!= 30 && indexs != 60 && indexs != 100 && indexs != 200)" style="display:flex">
                ...
                <td class="title-colors-red title-width" style="flex:3;">
                  <span v-for="(item,index) in items.res" v-if="index < 4" style="margin-right:0.1rem">{{item}}</span>
                  <span v-for="(item,index) in items.res" v-if="index > 4" style="margin-right:0.05rem;color:#35b5fe">{{item}}</span>
                </td>
        ...
        <div id="wanwei" class="wanwei">
          ...
          <div class="periods">
            ...
            <div class="wan_list" ref="wan_list">
                 <!-- 左边表格期数 -->
                <div class="wan_table_2" style="flex:1.96">
            ...
            <div class="bottom_list" style="margin-bottom: 0.89rem;width:25rem;display:flex;">
              <ol style="flex:1.93">
                <li>总共出现</li>
                <li>最大连出</li>
                <li>最大遗漏</li>
              ...
              <ol v-for="(items,indexs) in this.bottom_list" v-if="indexs < 36" style="flex:1">
           ...
           <div class="periods">
            <!-- 表头 -->
              ...
              <div class="bottom_list" style="margin-bottom: 0.89rem;width:25rem;display:flex;">
                ...
                <ol v-for="(items,indexs) in this.bottom_list_2" v-if="indexs < 36" style="flex:1">
                  <li>{{items.total_appear}}</li>
                  <li>{{items.continue_max}}</li>
                  <li>{{items.omit_max}}</li>
                  <li>{{ Math.floor(items.omit_mean)}}</li>
      ...
      requestOpt.reqnoGetpara(
        ...
        res => {
          ...
          document.querySelector(".mint-loadmore-top").style.color = "#666";
            ...
            setTimeout(function() {
              that.draw_cvs(len,'.lan1_table_3','#my_draw_lan1','#canvas_lan1',that.lan1_data_list);
            }, 100);
            setTimeout(function() {
              that.draw_cvs(len,'.lan2_table_3','#my_draw_lan2','#canvas_lan2',that.lan2_data_list);
            }, 100);
